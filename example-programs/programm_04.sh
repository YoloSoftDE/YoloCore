...
echo -ne "\x1e\x81\x3f\x5f\x81\x3f\xa8\xe1" #0x00 - 0x07
echo -ne "\x1e\x3d\x7f\xa0\x1f\x7e\x3f\x1d" #0x08 - 0x0f
echo -ne "\x5e\xe8\x00\x00\x00\x00\x00\x00" #0x10 - 0x17
echo -ne "\x00\x00\x00\x00\x00\x00\x01\x00" #0x18 - 0x1f
